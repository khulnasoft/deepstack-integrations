...
layout: integration
name: Context AI
description: A component to log conversations for analytics by Context.ai - built for Deepstack 2.0.
authors:
    - name: Alec Barber
      socials:
        github: BarberAlec
...
pypi: https://pypi.org/project/context-deepstack/
repo: https://github.com/contextco/context-deepstack
type: Monitoring Tool
report_issue: https://github.com/contextco/context-deepstack/issues
...
```bash
pip install --upgrade context-deepstack
```
...
from context_deepstack.context import ContextAIAnalytics
...
## License
`context-deepstack` is distributed under the terms of the [Apache-2.0](https://spdx.org/licenses/Apache-2.0.html) license.
