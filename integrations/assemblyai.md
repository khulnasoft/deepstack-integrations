...
layout: integration
name: AssemblyAI
description: Use AssemblyAI transcription, summarization and speaker diarization models with Deepstack
authors:
    - name: AssemblyAI
      socials:
        twitter: assemblyai
        github: AssemblyAI
        linkedin: assemblyai
pypi: https://pypi.org/project/assemblyai-deepstack/
repo: https://github.com/AssemblyAI/assemblyai-deepstack
type: Model Provider
report_issue: https://github.com/AssemblyAI/assemblyai-deepstack/issues
...
You can use [AssemblyAI](https://www.assemblyai.com/) trancriptions in your Deepstack 2.0 pipelines with the AssemblyAITranscriber.
