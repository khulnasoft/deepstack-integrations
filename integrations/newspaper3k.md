...
authors:
    - name: Haradai
      socials:
        github: haradai
pypi: https://pypi.org/project/newspaper3k-deepstack
repo: https://github.com/Haradai/newspaper3k-deepstack
type: Data Ingestion
report_issue: https://github.com/Haradai/newspaper3k-deepstack/issues
---

Newspaper3k Deepstack is a simple wrapper for the newspaper3k library within the Deepstack framework. It allows to scrape articles given urls using the scraper node or crawl many pages using the crawler node.

## Installation:
You can install Newspaper3k Deepstack using pip:
```
pip install newspaper3k-deepstack
```

## Usage:
### Scraper Node:
```
from newspaper3k-deepstack import newspaper3k_scraper
...
from deepstack.nodes import EntityExtractor
...
### Crawler Node:
```
from newspaper3k-deepstack import newspaper3k_crawler
```
