...
description: Use Google Vertex AI Models with Deepstack
authors:
    - name: khulnasoft
      socials:
        github: khulnasoft
        ...
        linkedin: khulnasoft
pypi: https://pypi.org/project/google-vertex-deepstack/
repo: https://github.com/khulnasoft/deepstack-core-integrations/tree/main/integrations/google_vertex
type: Model Provider
...
Deepstack supports [Gemini API models](https://cloud.google.com/vertex-ai/docs/generative-ai/learn/models#gemini-models), [PaLM API models](https://cloud.google.com/vertex-ai/docs/generative-ai/learn/models#palm-models), [Codey APIs models](https://cloud.google.com/vertex-ai/docs/generative-ai/learn/models#codey-models), and [Imagen API models](https://cloud.google.com/vertex-ai/docs/generative-ai/learn/models#imagen-models) for task such as **text generation**, **function calling**, **image generation**, **visual question answering**, **code generation**, and **image captioning**.

> To learn more about the use cases and test Vertex AI models with Deepstack, follow this [Colab Notebook](https://colab.research.google.com/drive/1hOLxbLHsyGsOd6E9qjA-CnZSH-eoLxp8?usp=sharing).

> There is an article about Gemini models and how to use them with Deepstack: [Gemini Models with Google Vertex AI Integration for Deepstack](https://deepstack.khulnasoft.com/blog/gemini-models-with-google-vertex-for-deepstack)
...
- [`VertexAIGeminiGenerator`](https://docs.deepstack.khulnasoft.com/docs/vertexaigeminigenerator): Use this component with Gemini models '**gemini-pro**' and '**gemini-pro-vision**' for text generation and multimodal prompts.
- [`VertexAIGeminiChatGenerator`](https://docs.deepstack.khulnasoft.com/docs/vertexaigeminichatgenerator): Use this component with Gemini models '**gemini-pro**' and '**gemini-pro-vision**' for text generation, multimodal prompts and function calling in chat completion setting.
...
- [`VertexAIImageCaptioner`](https://docs.deepstack.khulnasoft.com/docs/vertexaiimagecaptioner): Use this component with Imagen model '**imagetext**' for image captioning.
...
```python
from deepstack_integrations.components.generators.google_vertex import VertexAITextGenerator
...
```python
from deepstack_integrations.components.generators.google_vertex import VertexAICodeGenerator
...
You can leverage Imagen models through three components: [VertexAIImageCaptioner](https://docs.deepstack.khulnasoft.com/docs/vertexaiimagecaptioner), `VertexAIImageGenerator` and `VertexAIImageQA`.
...
from deepstack_integrations.components.generators.google_verteximport VertexAIImageGenerator
...
```python
from deepstack_integrations.components.generators.google_vertex import VertexAIImageCaptioner
...
```python
from deepstack.dataclasses.byte_stream import ByteStream
from deepstack_integrations.components.generators.google_vertex import VertexAIImageQA
