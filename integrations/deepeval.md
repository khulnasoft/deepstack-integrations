...
authors:
    - name: khulnasoft
      socials:
        ...
        linkedin: khulnasoft
pypi: https://pypi.org/project/deepeval-deepstack
repo: https://github.com/khulnasoft/deepstack-core-integrations/tree/main/integrations/deepeval
...
Once installed, you will have access to a [DeepEvalEvaluator](https://docs.deepstack.khulnasoft.com/docs/deepevalevaluator) that supports a variety of model-based evaluation metrics: 
- Answer Relevancy
- Faithfulness
...
from deepstack_integrations.components.evaluators.deepeval import DeepEvalEvaluator, DeepEvalMetric
