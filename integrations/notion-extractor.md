...
description: A component to extract pages from Notion to Deepstack Documents. Useful for indexing Pipelines.
authors:
    - name: Bogdan Kostić
      socials:
        github: bogdankostic
pypi: https://pypi.org/project/notion-deepstack/
repo: https://github.com/bogdankostic/notion-deepstack
type: Data Ingestion
report_issue: https://github.com/bogdankostic/notion-deepstack/issues
logo: /logos/notion.png
---
This Deepstack component allows you to easily export your Notion pages to Deepstack Documents by providing a Notion API token.
...
The following minimal example demonstrates how to export a list of pages to Deepstack Documents:
```python
from notion_deepstack import NotionExporter

exporter = NotionExporter(api_token="<your-token>")
exported_pages = exporter.run(file_paths=["<list-of-page-ids>"])

# exported_pages will be a list of Deepstack Documents where each Document corresponds to a Notion page
```
